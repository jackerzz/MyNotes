...
def image_merge(images, output_dir='output', output_name='merge.jpg',restriction_max_width=750, restriction_max_height=600):  
    """垂直合并多张图片 
    images - 要合并的图片路径列表 
    ouput_dir - 输出路径 
    output_name - 输出文件名 
...
if __name__ == '__main__':  
    image_merge(images=['12220.jpg', '12220.jpg'])